 ...
 * [EventFragment.OnEventFragmentInteractionListener] interface.
 */
class EventFragment : Fragment() {
    ...
    private var listener: OnEventFragmentInteractionListener? = null
    ...
    override fun onAttach(context: Context) {
        ...
        if (context is OnEventFragmentInteractionListener) {
            listener = context
        } else {
     ...
     */
    interface OnEventFragmentInteractionListener {
        // TOD Update argument type and name
        fun onEventFragmentInteraction(id: String)
    }
